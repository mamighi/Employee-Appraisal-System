	...
	<body class="subpage">
		...
		<!-- Main -->
			<div id="main">
				...
				<div>
				          <?php
	$sql = "SELECT * FROM `appraisal_employee` where reviewLevel=2 and employee_id='$uid'";
	$q =mysqli_query($conn,$sql);
	$totalCnt =mysqli_num_rows($q);
	if ($totalCnt > 0) {
	$query = mysqli_query($conn,$sql);
	?>
      <form name="f" method="post" action="empAppraisalReport.php">
         	<div >
	...
	var uid=sessionStorage.getItem("id");
       ...
       $.ajax({
				...
				success: function (html) 
				{
	                ...
	                window.location.href = "https://appraizal.000webhostapp.com/empAppraisalReport.php";
