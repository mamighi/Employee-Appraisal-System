	...
	<body class="subpage">
		...
		<!-- Main -->
			<div id="main">
				...
				<div>
				          <?php
 	$sql = "SELECT * FROM `appraisal_employee` WHERE employee_id='$uid' AND reviewLevel='0'";
      ...
      <form name="f" method="post" action="employeeList.php">
        ...
        <table  width="40%">
          ...
          <tr>
            ...
            <td style="text-align:center;"><button id="edit" class="button fit" onclick="edit_item(<?php echo $rs->id;?>)"style="width:120px;height:40px; background:grey">Evaluate</button></td>
       ...
       $.ajax({
				...
				success: function (html) 
				{
				   // alert(html);
	                ...
	                window.location.href = "performanceAppraisal.php";
