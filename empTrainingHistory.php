...
th{
  background-color: #ACA6A4;
	...
	<body class="subpage">
		...
		<!-- Main -->
			<div id="main">
				...
				<div>
				          <?php
	$sql = "SELECT * FROM `training_programme` WHERE id IN (SELECT `training_id` FROM `training_employees` WHERE `employee_id`='$uid' and `attended`='2')";
	...
	?>
      ...
      <form name="f" method="post" action="empTrainingHistory.php">
         	<div >
        <div class="height20"></div>
