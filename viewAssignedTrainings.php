	...
	<body class="subpage">
		...
		<!-- Main -->
			<div id="main">
				...
				<div>
				          <?php
 	$sql = "SELECT * FROM `training_programme` WHERE id IN (SELECT `training_id` FROM `training_employees` WHERE `employee_id`='$uid' and `attended`='0')";
      ...
      <form name="f" method="post" action="employeeList.php">
        ...
        <table  width="40%">
          ...
          <tr>
            ...
            <td style="text-align:center;"><button id="edit" class="button fit" onclick="edit_item(<?php echo $rs->id;?>)"style="width:120px;height:40px; background:grey">Attended</button></td>
