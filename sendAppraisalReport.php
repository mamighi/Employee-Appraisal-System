...
if (isset($_POST["sub"])) {
	...
	//	$all = implode(",", $_POST["ids"]);
	    foreach($_POST["ids"] as $ab){
	        ...
	        $sql = "INSERT INTO `employeeReview_employee`(`appraisal_id`, `emp_id`) VALUES ('$tid','$ab')";
	   

		if ( @mysqli_query($conn,$sql)) {
		    $errmsg = errorMessage("Successfully Assigned");
...
<style>
 ...
 th{
  background-color: #ACA6A4;
	...
	?>
      <form name="f" method="post" action="sendAppraisalReport.php">
     <div id ="load_tweets">
        <div>
