      ...
      <form name="f" method="post" action="employeeList.php">
        ...
        <table  width="40%">
          ...
          <tr>
            ...
            <td style="text-align:center;"><button id="send" class="button fit" onclick="sendreport(<?php echo $rs->id;?>)"style="width:120px;height:40px; background:grey">Send Report</button></td>
          </tr>
          <?php } ?>
       ...
       $.ajax({
				...
				success: function (html) 
				{
				   // alert(html);
					sessionStorage.setItem("xid",id);
					sessionStorage.setItem("uid",uid);
	                window.location.href = "https://appraizal.000webhostapp.com/sendAppraisalReport.php?tid="+id;
